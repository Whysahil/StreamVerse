  ...
  return (
    <div 
      className={cn(
        ...
        inGrid ? "w-full" : (isLargeRow ? "w-[140px] md:w-[178px] lg:w-[220px]" : "w-[140px] md:w-[178px] lg:w-[240px]"),
    ...
    >
      ...
      */}
      <div className={cn(
        ...
        isHovered && !isLargeRow ? "scale-[1.1] md:scale-[1.35] z-50 shadow-[0_0_40px_rgba(0,0,0,0.8)]" : "scale-100 z-10 overflow-hidden h-full",
        ...
        {isHovered && !isLargeRow && (
          <div className="w-full bg-[#141414] p-3 md:p-4 rounded-b-lg border border-t-0 border-white/10 animate-in fade-in slide-in-from-top-2 duration-300 hidden md:block">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <button 
                  ...
                  onClick={toggleList}
                >
                  {isSaved ? <Check className="w-3 h-3 md:w-4 md:h-4 group-hover/btn:scale-110 transition" /> : <Plus className="w-3 h-3 md:w-4 md:h-4 group-hover/btn:scale-110 transition" />}
                </button>
              </div>
              <button 
            ...
            <div className="flex items-center gap-2 text-[10px] md:text-xs font-semibold text-gray-400 mb-1">
              ...
              <span className="border border-gray-600 px-1 rounded-[2px] leading-none text-[8px] md:text-[10px]">HD</span>
            </div>
