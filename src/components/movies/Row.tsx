...
export function Row({ title, fetchUrl, isLargeRow = false }: RowProps) {
  ...
  if (error) {
    return (
      <div className="space-y-2 py-4 px-4 md:px-12 group relative z-20">
        <h2 className="text-lg md:text-xl font-semibold mb-2 flex items-center gap-3 text-white/50 tracking-wide">
          {title}
        </h2>
  ...
  if (loading) {
    return (
      <div className="space-y-2 py-4 px-4 md:px-12 group relative z-20 overflow-hidden">
        <h2 className="text-lg md:text-xl font-semibold mb-2 flex items-center gap-3 text-white/90 tracking-wide">
          ...
          {[...Array(6)].map((_, i) => (
            <div
              ...
              className={cn(
                ...
                isLargeRow
                  ? "w-[38vw] md:w-[26vw] lg:w-[16vw] xl:w-[14vw] aspect-[2/3]"
                  : "w-[42vw] md:w-[30vw] lg:w-[18vw] xl:w-[16vw] aspect-video",
              )}
            />
          ))}
        </div>
